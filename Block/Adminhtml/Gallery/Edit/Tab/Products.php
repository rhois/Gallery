...
class Displaystore_Gallery_Block_Adminhtml_Gallery_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct() {
        parent::__construct();
        $this->setId('galleryLeftGrid');
    ...
    protected function _prepareColumns() {
        ...
        if ($store->getId()) {
            $this->addColumn('custom_name',
                    array(
                        'header' => Mage::helper('gallery')->__('Name in %s', $store->getName()),
                        'index' => 'custom_name',
            ));
        }
        ...
        $this->addColumn('set_name',
                array(
                    'header' => Mage::helper('gallery')->__('Attrib. Set Name'),
                    'width' => '100px',
        ...
        $this->addColumn('sku',
                array(
                    'header' => Mage::helper('gallery')->__('SKU'),
                    'width' => '80px',
                    'index' => 'sku',
        ));
...
//        ));
        ...
        $this->addColumn('qty',
                array(
                    'header' => Mage::helper('gallery')->__('Qty'),
                    'width' => '100px',
                    'type' => 'number',
                    'index' => 'qty',
        ));
        ...
        $this->addColumn('visibility',
                array(
                    'header' => Mage::helper('gallery')->__('Visibility'),
                    'width' => '70px',
                    'index' => 'visibility',
                    'type' => 'options',
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $this->addColumn('websites',
                    array(
                        'header' => Mage::helper('gallery')->__('Websites'),
                        'width' => '100px',
                        'sortable' => false,
                        'index' => 'websites',
                        'type' => 'options',
